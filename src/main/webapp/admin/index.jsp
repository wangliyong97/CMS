			...
			<ul class="nav" id="side-menu">
				<li class="nav-header">
					<div class="dropdown profile-element">
							<span><img alt="images" style="width:64px;height:64px;"class="img-circle"
									   src="${pageContext.request.contextPath}/images/person.png" /></span>
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span
								class="clear"> <span class="block m-t-xs"><strong
								class="font-bold">管理员</strong></span>
							</span>
						</a>
					</div>
				...
				<li><a href="#"><i class="fa fa-book"></i> <span class="nav-label">活动模块</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem"
							   href="${pageContext.request.contextPath}/admin/activity/activityTable.jsp">活动管理</a>
						</li>
						<li><a class="J_menuItem"
							   href="${pageContext.request.contextPath}/admin/activity/addActivity.jsp">编辑活动</a>
						</li>
						<li><a class="J_menuItem"
							   href="${pageContext.request.contextPath}/admin/activity/findActivity.jsp">查询活动</a>
						</li>
						<li><a class="J_menuItem"
							   href="${pageContext.request.contextPath}/admin/activity/activityType.jsp">类别</a>
						</li>
					</ul>
				</li>
