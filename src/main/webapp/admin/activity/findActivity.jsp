				...
				<div class="ibox-content mailbox-content">
					<div class="file-manager">
						<a class="btn btn-block btn-primary compose-mail"
						   href="javascript:void(0);">活动查询</a>
						<div class="space-25"></div>
						<h5 class="tag-title">搜索</h5>
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" onkeyup="findActivityByKey()"
									   placeholder="请输入关键字" id="blogname" class="form-control" style="width:76%;">
								<button id="findBlog" onclick="findActivityByKey()"
...
<script src="${pageContext.request.contextPath}/js/admin/activity/findActivity.js"></script>
</body>
</html>
