...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/page/apply.css" rel="stylesheet">
                    ...
                    <div class="mail-box">
                        ...
                        <div class="mail-body text-right tooltip-demo">
                            ...
                            <button id="prev2" type="button" style="display:none"
                                    onclick="prevWebActivity()" data-target="#myModal" data-toggle="modal">
                            </button>
...
<script src="${pageContext.request.contextPath}/js/page/apply.js"></script>
</body>
</html>
