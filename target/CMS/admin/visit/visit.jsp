...
<body class="white-bg" style="opacity:0">
						...
						<div class="file-manager">
							...
							<ul class="folder-list m-b-md" style="padding: 0">
								<li><a href="${pageContext.request.contextPath}/admin/visit/visit.jsp">
										<i class="fa fa-inbox "></i>记录数<span class="a-1 label label-info pull-right">0 </span>
								</a></li>
								<li><a href="${pageContext.request.contextPath}/admin/visit/visitTable.jsp">
										<i class="fa fa-user "></i>用户数<span class="a-2 label label-warning pull-right">0 </span>
								</a></li>
								<li><a href="${pageContext.request.contextPath}/admin/visit/black.jsp">
										<i class="fa fa-lock "></i>黑名单<span class="a-3 label label-danger pull-right">0 </span>
								</a></li>
							</ul>
							<h5>指定日期查询</h5>
			...
			<div class="col-sm-9">
				<div class="ibox float-e-margins">
					<div class="mail-box-header">
						<h2>访客记录</h2>
						<table id="allVisit" data-mobile-responsive="true"></table>
    ...
    <script src="${pageContext.request.contextPath}/js/admin/visit/visit.js"></script>
</body>
