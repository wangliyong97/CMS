...
<body class="signin">
	<div class="signinpanel">
			...
			<div class="col-sm-7">
				<div class="signin-info">
					...
					<div class=" tooltip-demo ">
						<strong>还没有账号？<a href="${pageContext.request.contextPath}/index.jsp" style="color:#3c3a39;margin-left:15px;">首页&raquo;</a></strong>
					</div>
				</div>
			</div>
			<div class="col-sm-5">
				<form id="login" action="${pageContext.request.contextPath}/checkLogin" method="post">
                    ...
                    <a style="color:#101010de" href="javascript:void(0);">忘记密码？</a>
		...
		<div class="signup-footer">
			<div class="pull-left">
				<strong>&copy; 2019 njupt cms</strong>
			</div>
		</div>
	</div>
